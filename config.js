...
global.github = 'https://github.com/rmjmadu/WHITEALFHA-MD'
global.location = 'Sultanpur IN'
global.gurl = 'https://instagram.com/' // add your username
global.devs = '94705106657';
global.website = 'https://github.com/rmjmadu/WHITEALFHA-MD' //wa.me/+94705106657
...
module.exports = {
  ...
  botname: process.env.BOT_NAME || 'WHITEALFHA-MD',
  dl_limit: process.env.DL_SIZE || '300',
  art: process.env.AUTO_RESTART || 'true',
  sudo: process.env.SUDO || '94705106657',
  alivepic: process.env.ALIVE_IMG || 'https://i.ibb.co/p22J5nQ/file-1nh1gowb-Fqjz1-YJGzgo8u1e-J.jpg',
  alivemsj: process.env.ALIVE_MSJ || '*POWERD BY WHITEALFHA OFICIAL* 🎊',
  ownername:process.env.OWNER_NAME || 'WHITEALFHA',
  ...
  LANG: process.env.THEME|| 'WHITEALFHA-MD',
